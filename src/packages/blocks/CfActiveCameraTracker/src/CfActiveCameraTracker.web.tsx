...
import CfActiveCameraTrackerController, {
  Props,
  configJSON,
} from "./CfActiveCameraTrackerController";

export default class CfActiveCameraTracker extends CfActiveCameraTrackerController {
