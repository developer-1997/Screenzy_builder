...
import CfTeamviewerDeviceControl3rdPartyIntegController, {
  Props,
  configJSON,
} from "./CfTeamviewerDeviceControl3rdPartyIntegController";

export default class CfTeamviewerDeviceControl3rdPartyInteg extends CfTeamviewerDeviceControl3rdPartyIntegController {
